<template>
  <div class="info-row">
    <div class="info-row__winner-banner">
      <app-winner-banner :winner="winner" />
    </div>
    <div class="info-row__main main-info">
      <span
        class="info-row__kills info-row__kills--radiant"
      ...
      <span
        class="info-row__kills info-row__kills--dire"
        v-text="details.dire_score"
      />
    </div>
    <dl class="info-row__additional">
      <dt>ID матча</dt>
